...
/// @dev Works in conjunction with PermanentLocksPoolV1 to manage rewards
contract SwapperV1 {
    ...
    IPermanentLocksPoolV1 public immutable locks_pool;
    ...
    /// @param _locks_pool Address of the PermanentLocksPoolV1 contract
    constructor(IUniversalRouter _router, IPermanentLocksPoolV1 _locks_pool) {
        router = _router;
